...
**SlopScore** — paste a URL or drop content text → get a brutal, shareable verdict card that scores it on:
...
[Soft gate] — to share publicly or run more than 3 roasts → sign up (email + first use event)
    ↓
Public roast page at slopcheck.app/roast/[id]
```
...
| 4 | Score card UI | AI Slop %, Originality %, FU Score. One-line savage verdict. Clean, bold, dark card design. |
...
- ai_slop_score: 0-100 (how AI-generated does this feel? Look for: generic frameworks, listicle structure, hedging language, no personal anecdotes, "In today's fast-paced world" type openers)
